...
<head>
  <meta charset="UTF-8">
  <title>Oooops! Página não encontrada</title>
  <meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css">
<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.3/css/bootstrap.min.css'><link rel="stylesheet" href="/dist/css/style404.css">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        ...
        <p>Vamos trabalhar para consertar isso imediatamente. Enquanto isso, você pode retornar à página inicial.
        </p>
        <a href="/" class="btn green">Início</a>
      </div>
    </div>
  </div>
</main>
<!-- partial -->
  <script src='https://cdnjs.cloudflare.com/ajax/libs/gsap/3.1.1/gsap.min.js'></script><script  src="/dist/js/script404.js"></script>
