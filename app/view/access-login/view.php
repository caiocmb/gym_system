                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control select2" style="width: 100%;" id="profile" name="profile" required>
                ...
                <div class="card-footer">
                  <div class="row">
                      ...
                      <div class="col-sm-2" style="margin-top: 5px;">
                        <button type="button" class="btn btn-block btn-default btn-sm pull-left" value="../../access-login/"  onclick='window.location.href=this.value'>Voltar</button>
                      </div>
