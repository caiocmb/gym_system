            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="float-left btn-group">
                   <button type="button" class="btn btn-secondary" value="/<?php echo $_ENV['PASTA_APP_NAME']; ?>/api-user/create/" onclick='window.location.href=this.value'>Cadastrar</button>
                </div>
